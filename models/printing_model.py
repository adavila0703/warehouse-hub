...
class PrintingModel(db.Model):
    """Printing data structure"""
    __tablename__ = 'printing_table'
    ...
    def get_all_data(cls):
        """Get all printing data"""
        obj = cls.query.filter(PrintingModel.complete == '' and PrintingModel.rec_date == '' and
                               PrintingModel.start_date == '')
        return obj
